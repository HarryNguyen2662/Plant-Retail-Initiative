          ...
          children: [
            Text(
              ...
              style: GoogleFonts.lobster(
                color: (Get.isDarkMode)
                    ? const Color.fromARGB(255, 221, 234, 218)
                    : Color.fromARGB(255, 19, 72, 48),
                            ...
                            children: [
                              Expanded(
                                child: Transform.scale(
                                  scale: 1,
                                  child: Image.asset(
                                    'assets/images/bonsai/Australian_Weeping_Willow_Bonsai_Tree.png',
                                  ),
                                ),
                              ),
                            ],
                              ...
                              Expanded(
                                ...
                                child: Transform.scale(
                                  ...
                                  child: Transform.scale(
                                    scale: 0.7,
                                    child: Image.asset(
                                        'assets/images/bonsai/Fukien_Tea.png'),
                                  ),
                                ),
                              ),
                            ],
                            ...
                            children: [
                              Expanded(
                                child: Transform.scale(
                                  scale: 1,
                                  child: Image.asset(
                                    'assets/images/bonsai/pink_blossom.png',
                                  ),
                                ),
                              ),
                            ],
                            ...
                            children: [
                              Expanded(
                                child: Transform.scale(
                                  scale: 1,
                                  child: Image.asset(
                                    'assets/images/bonsai/Green_Mound_Juniper.png',
                                  ),
                                ),
                              ),
                            ],
